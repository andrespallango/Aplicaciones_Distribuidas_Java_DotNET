...
public class BancoControlador {
    ...
    private BancoVista bancoVista = new BancoVista();
    ...
    public synchronized void transferirEntreCuentas(Banco banco, int cuentaOrigen, int cuentaDestino, double cantidad)
        ...
        bancoVista.mostrarDetallesTransferencia(banco, cuentaOrigen, cuentaDestino, cantidad, obtenerSaldoTotal(banco));
